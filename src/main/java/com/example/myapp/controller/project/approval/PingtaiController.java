...
public class PingtaiController {
    ...
    public AjaxResult addApproval(@RequestBody Pingtai pingtai) throws Exception {
        BaseContext.setCurrentUserAndUnion("12345","pingtai","661261433");
        ...
        process.setBaseId(pingtai.getBaseId());
        process.setDeptId("661261433");
        process.setApprovalBy(myValues.getUserId());
        process.setApprovalStatus(pingtai.getApprovalStatus());
    ...
    public AjaxResult updateApproval(@RequestBody Pingtai pingtai) throws Exception {
        BaseContext.setCurrentUserAndUnion("12345","pingtai","661261433");
